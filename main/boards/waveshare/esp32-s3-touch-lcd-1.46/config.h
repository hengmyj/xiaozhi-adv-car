...
// External UART command TX settings. GPIO43 must only carry control bytes such as "L1".
#define EXTERNAL_UART_NUM        UART_NUM_0
#define EXTERNAL_UART_BAUD_RATE  115200
#define EXTERNAL_UART_TX_PIN     GPIO_NUM_43
// RX is not bound for the command UART; GPIO43 is TX-only for chassis commands.
#define EXTERNAL_UART_RX_PIN     GPIO_NUM_44
